...
export const buildOperatorServerOwnerInspectionScript = (
  ...
  [
      ...
      "    return $hostFlags.Count -eq 1 -and $hostValue.Count -eq 1 -and $portFlags.Count -eq 1 -and $portValue.Count -eq 1",
      '  }',
